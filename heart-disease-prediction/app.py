...
# Home Page
if page == "🏠 Home":
    st.markdown('<div class="main-header">❤️ Heart Disease Prediction System – Supporting SDG 3: Good Health & Well‑being</div>', unsafe_allow_html=True)
    ...
    with col1:
        ...
        st.markdown('<div class="sub-header">🎯 Key Targets of SDG 3</div>', unsafe_allow_html=True)
        st.write("""
        - Reduce premature deaths from non‑communicable diseases  
        - Promote mental and physical health  
        - Improve access to healthcare services  
        - Strengthen disease prevention and early diagnosis  
        - Support healthy lifestyles and well‑being
        """)
        
        st.markdown('<div class="sub-header">❤️ Why Heart Disease Matters</div>', unsafe_allow_html=True)
        st.write("""
        Cardiovascular diseases are responsible for millions of deaths every year. Many heart conditions develop gradually and often show warning signs that can be detected early through regular monitoring and health assessments.
        ...
        **Common risk factors include:**
        ...
        st.markdown('<div class="sub-header">✅ How This Project Supports SDG 3</div>', unsafe_allow_html=True)
        st.write("""
        This project contributes to SDG 3 by:
        - Encouraging preventive healthcare
        - Increasing awareness of cardiovascular health
        - Providing quick risk assessment
        ...
        st.write("""
        This web application uses machine learning to predict the likelihood of heart disease based on clinical parameters. It provides explainable insights to assist healthcare professionals and individuals in early risk assessment – a key step toward better global heart health.
        ...
        **🎯 Key Features:**
        ...
        st.write("""
        The model was trained on a clinical heart disease dataset containing records with cardiovascular metrics such as cholesterol levels, blood pressure, ECG readings, and other vital signs.
    ...
    with col2:
        ...
        **🔗 GitHub:** https://github.com/sajal-samanta  
        ...
        This project demonstrates an end‑to‑end ML application for healthcare, aligned with **SDG 3**.
        """)
